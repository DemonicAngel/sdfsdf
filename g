...
local Window = Library.CreateLib("Universal Scripts", "Ocean")
...
MainSection:NewButton("Anti AFK", "Stops you from going AFK", function()
    loadstring(game:HttpGet("https://pastebin.com/raw/sDXcYFhR", true))()
end)

MainSection:NewButton("Lag Reducer", "Reduces your lag", function()
...
MainSection:NewToggle("Super-Human", "Increases your walkspeed and jump power", function(state)
    if state then
...
PlayerSection:NewSlider("Walkspeed", "Go Faster", 500, 16, function(s)
...
PlayerSection:NewButton("Noclip", "Press E to toggle on and off", function()
    loadstring(game:HttpGet('https:/spastebin.com/Um9w5wmz'))()
end)
...
OtherSection:NewButton("Bypassed Fly", "Makes you fly", function()
    loadstring(game:HttpGet(("https://raw.githubusercontent.com/Nicuse/RobloxScripts/main/BypassedFly.lua"),true))()
    
    Fly(true)
end)

PlayerSection:NewButton("Infinite Jump", "Press R to turn it on and off", function()
    loadstring(game:HttpGet('https://pastebin.com/rZeN4p4F'))()
end)

OtherSection:NewButton("Free Cam", "Press Shift P to toggle Q and E to move", function()
    loadstring(game:HttpGet(('https://pastebin.com/raw/djBfk8Li'),true))()
end)

OtherSection:NewButton("ESP", "Universal ESP", function()
